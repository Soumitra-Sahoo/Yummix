 ...
 *
 * Props:
 *  rating      {number}   — current value (0–5, supports decimals for display)
 *  count       {number}   — total ratings (optional, shown next to stars)
 *  interactive {boolean}  — if true, renders clickable stars
 *  onRate      {function} — called with star value when clicked
