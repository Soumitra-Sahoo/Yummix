  ...
  return (
    <div className="about">
      ...
      <div className="about-section">
        <h2>Our Story</h2>
        <p>Yummix was created with one simple goal — to make food ordering effortless and enjoyable. From local street food to premium restaurants, we bring everything to your fingertips.</p>
      </div>
      <div className="about-section">
        <h2>Our Mission</h2>
